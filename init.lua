...
----------------------------------------------------------------------------------------------------------------
-- Bootstrapped from https://raw.githubusercontent.com/radleylewis/nvim-lite/refs/heads/youtube_demo/init.lua --
----------------------------------------------------------------------------------------------------------------
...
local fexpr = "v:lua.vim.treesitter.foldexpr()"
-- vim.wo.vim.foldexpr = fexpr                       -- Use treesitter for folding
...
vim.keymap.set("n", "<C-j>", "12j",  { desc = "Move 12 linues down" })
vim.keymap.set("n", "<C-k>", "12k",  { desc = "Move 12 linues up" })
vim.keymap.set("n", "<C-h>", "^",    { desc = "Move to first printable char" })
vim.keymap.set("n", "<C-l>", "100|", { desc = "Move to column 100 (or last char)" })
...
-- Filetype: jabbascript, web stuff
vim.api.nvim_create_autocmd("FileType", {
  group = augroup,
